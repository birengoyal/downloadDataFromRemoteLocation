...
public class HttpConnector {
	...
	protected URLConnection getConnection(URL url, Proxy proxy) throws IOException, KeyManagementException,
		...
		if ("http".equalsIgnoreCase(url.getProtocol()) || "ftp".equalsIgnoreCase(url.getProtocol())) {
			URLConnection conn = url.openConnection(proxy == null ? Proxy.NO_PROXY : proxy);
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	protected URLConnection getSecureConnection(URL url) throws IOException, KeyManagementException,
			NoSuchAlgorithmException {
	 ...
	 * @throws KeyManagementException
	 */
	protected URLConnection getSecureConnection(URL url, Proxy proxy) throws IOException,
